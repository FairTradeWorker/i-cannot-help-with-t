                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              ...
                              <div className="p-2 rounded-lg bg-primary/10 group-hover:bg-primary/20 transition-all duration-300 group-hover:scale-110 flex-shrink-0">
                                <Icon className="w-4 h-4 md:w-5 md:h-5 text-primary" weight="duotone" />
                              </div>
