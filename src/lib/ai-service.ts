...
// NOTE: This function has been moved to src/lib/invoice-ocr.ts
// Keeping this as a re-export for backward compatibility
export { uploadInvoiceImages } from './invoice-ocr';
